...
class BayesianNeuralNetworkSVGD(RegressionModel):
    ...
    def __init__(self, x_train, y_train, hidden_layer_sizes=(32, 32, 32, 32), activation='relu',
                 ...
                 n_particles=10, bandwidth=100., lr=1e-3, meta_learned_prior=None, batch_size=8,
    ...
    def step(self, x_batch, y_batch):
        ...
        with tf.GradientTape(watch_accessed_variables=False) as tape:
            ...
            if self.meta_learned_prior_mode:
                ...
                prior_prob = tf.reshape(
                    self.prior.log_prob(particles_reshaped, model_params_prior_weight=self.prior_weight),
                    (self.n_particles,))
            else:
